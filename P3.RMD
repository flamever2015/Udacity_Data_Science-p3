...
### 待补充结论 - 这些特性之间是否存在有趣或惊人的联系呢？
可以探索身份认证内部的关联
```{r}
# 各种身份认证的子集
LCIS_Cert <- LCIS[, c("手机认证指数", "户口认证指数", "视频认证指数", "学历认证指数", "征信认证指数", "淘宝认证指数")]

# 绘制相关性系数矩阵
corrplot(cor(LCIS_Cert), method = 'number', number.digits = 1, number.cex = 1, addCoefasPercent = TRUE, family = 'STHeiti') 
