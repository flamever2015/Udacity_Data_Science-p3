...
- 最大的成功还款期数为2507，因为还款一般为每隔一个月还款一次，而成功还款2507相当于成功还款208年，这显然是错误数据。通过拍拍贷网站介绍(https://www.ppdai.com/help/aboutus)，查询到其业务开展于2007年6月，所以可确定最大的成功还款期数在10年，即120次。据此剔除错误数据。
